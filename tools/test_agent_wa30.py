"""
Test MyAgent on wa30 across 5 seeds.
"""
import sys
...
def test_agent_wa30():
    ...
    for seed in range(5):
        ...
        obs = env.reset()
        agent = MyAgent(card_id=None, game_id="wa30", agent_name="test", ROOT_URL="", record=False, arc_env=env)
    ...
    print(f"MY_AGENT WA30 SCORES: {scores}")
