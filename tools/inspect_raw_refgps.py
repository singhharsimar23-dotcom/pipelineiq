"""
Inspect refgps-plelvb2 raw pixels.
"""
import sys
...
print(f"refgps-plelvb2: name={s.name}, pos=({s.x}, {s.y}), size=({s.width}, {s.height}), interaction={s.interaction}")
pix = s.render()
print("Raw rendered pixels array:")
print(pix)
print(f"At (12, 20): dy={20-s.y}, dx={12-s.x} -> pixel value = {pix[20-s.y, 12-s.x]}")
